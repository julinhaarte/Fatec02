...
numMatricula int identity(1,1) Primary Key,
nome varchar(50),
dataAdimissao datetime,
salario float);

insert into cidade values ('Sorocaba','SP'), ('Votorantim','SP'), ('Florianopolis', 'SC'), ('Curitiba', 'PR'), ('Recife','PB'); 

insert into empregado values ('Julinha Soares',2024-04-01,3740.00), ('Ana Laura',2023-12-15,2800.50), ('Northon Braguin', 2024-03-19, 5430.00), ('Eduarda Brandini', 2024-02-27, 3100.00), ('Jones Artur', 2023-07-29,1500.00); 

 , '2024-03-19', '2024-02-27', '2023-07-29';
UPDATE empregado
SET dataAdimissao = '2024-02-27'
WHERE numMatricula=4

ALTER TABLE empregado
ALTER COLUMN dataAdimissao date;*/
...
select 'Código do Cliente' as'cod_cliente', 'Nome do Cliente'as 'nome_cliente'
from cliente

select nome, salario, salario+salario*0.3 aumento_salario
from empregado

select 'Funcionário: '+nome+'  Salário: '+CONVERT(varchar,salario)as 'Fusão',salario, nome
from empregado
...
select numMatricula, primeiro_nome, ultimo_nome, cod
